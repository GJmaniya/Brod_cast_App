...
app.post('/convert', upload.single('video'), (req, res) => {
    ...
    ffmpeg(inputPath)
        ...
        .outputOptions([
            ...
            '-autorotate'           // Auto-rotate videos from mobile phones based on orientation metadata
        ])
        .complexFilter([
            "scale=w=1920:h=1080:force_original_aspect_ratio=decrease,pad=1920:1080:(1920-iw)/2:(1080-ih)/2:color=black"
        ])
